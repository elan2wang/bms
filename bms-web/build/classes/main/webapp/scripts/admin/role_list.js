...
var role_update_api = "/bmp/1/roles/update";
var role_add_api = "/bmp/1/roles/add";
var role_delete_api = "/bmp/1/roles/delete";
var role_switch_api = "/bmp/1/roles/switch";
var role_view_api = "/bmp/1/roles/view";
var role_assign_auth_api = "/bmp/1/roles/assign_auth";
var mod_tree_api = "/bmp/1/modules/tree";
	...
	$.ajax({
		...
		success: function (result) {
			if(typeof(result.error_code) != "undefined"){
				$("#role_list").html('<tr><td colspan="8" style="text-align:center;"><span style="color:red;">'+result.error_msg+'</span></td></tr>');
			}
