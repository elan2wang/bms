...
function get_finance_table_str(items){//填充出账列表
	...
	if(items.length > 0){
		for(var i=0;i<items.length;i++){
			...
			list_str += '<td style="text-align:center;"><a class="edit" title="查看出账详情" href="javascript:void(0);" onclick="payment_detail_view('+id+'); return false;"><i class="icon-eye-open"></i></a></td>';
			list_str += '</tr>';
		}
	}
	return list_str;
